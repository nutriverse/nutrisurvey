...
# Measuring height {#sec-measure-height}

## Equipment {#sec-height-equipment}
...
::: {#fig-height-boards layout-ncol="3" layout-valign="bottom"}

![2-piece height board standing up](images/heightBoard01.jpg){#fig-2-piece-height-board-stand}

![2-piece height board lying down](images/heightBoard02.jpg){#fig-2-piece-height-board-lying}

![2-piece height board folded and carried](images/ShorrBrdcarry.jpg){#fig-shorrbrdcarry}

Different kinds of height boards

:::


## Personnel {#fig-measure-height-personnel}
...
## Steps in measuring length or height of child {#fig-measure-height-steps}
...
![Length board flat on a table surface](images/heightBoard03.png){#fig-board-recumbent fig-align="center"}

For children 24 months and older, height should be measured i.e., height board on the vertical position with the child standing up (unless child is unable to stand). Use a height board mounted at a right angle between a level floor and against a straight, vertical surface such as a wall or pillar (@fig-board-vertical).

![Height board mounted upright](images/heightBoard04.png){#fig-board-vertical fig-align="center"}

::: {.callout-note}

## Challenges with measuring length
...
### Measuring height {#sec-measure-height-steps}

![Steps in measuring height](images/height.png){#fig-measure-height fig-align="center"}
...
## Uncertainty about child's age

If you are unsure or not confident in the precision of the child's age (over age 2), please take measurement as described above. If the child's height is measured to less than 85 cm, you must instead measure the child's length (see @sec-measure-length-steps).
...
* heels not touching the board; and,
* hands not at side.

:::

### Measuring length {#sec-measure-length-steps}

![Steps in measuring length](images/length.png){#fig-measure-length-steps fig-align="center"}
...
6. **Assistant** cups hands over the child's ears (**arrow 4**). With arms comfortably straight (**arrow 5**), **assistant** places the child's head against the base of the board so that the child is looking straight up (@fig-measure-length-head-position). The child's line of sight should be perpendicular to the ground (**arrow 6**). The **assistant's** head should be straight over the child's head and looking directly into the child's eyes.

![Positioning child's head against the base of the board](images/heightBoard05.png){#fig-measure-length-head-position fig-align="center"}

7. **Measurer** makes sure the child is lying flat and in the centre of the board (**arrow 7**) and places left hand on the child's shins (above the ankles) or on the knees (**arrow 8**) pressing them firmly against the board (@fig-measure-length-work-together). Note that with the right hand, **measurer** places the footpiece firmly against the child's heels (**arrow 9**).

![Measurer and assistant working together to position child](images/heightBoard06.png){#fig-measure-length-work-together fig-align="center"}
...
If you are unsure or not confident in the precision of the child's age (under age 2), take measurement as described above. If the child's length is measured to 85 cm or more, you must instead measure the child's height (see @sec-measure-height-steps).
...
* toes pointed;
* knees bent; and, 
* head lifted off the board.

:::

::: {.callout-important}

## Reminders with measuring height/length
