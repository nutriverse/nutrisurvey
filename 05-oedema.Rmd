...
**Step 3** and **Step 4** are performed to be able to grade or classify the level of nutritional oedema the child is suffering from (if present).
  ...
  * Oedema below the ankes: +
  * Oedema in both feet and legs, below the knees: ++
  * Oedema on both feet, legs, arms and sacral pad and eye lids: +++
...
**Note:** Children with oedema (any grade) are at risk of dying and should be immediately referred to a health care facility (ideally a facility that manages severe acute undernutrition).
