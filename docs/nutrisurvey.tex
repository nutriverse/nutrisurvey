...
\textbf{Note:} Children with oedema (any grade) are at risk of dying and
should be immediately referred to a health care facility (ideally a
facility that manages severe acute undernutrition).
