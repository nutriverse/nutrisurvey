...
{\centering \includegraphics[width=37.62in]{images/accuracyPrecision} 
...
\item
  ...
  his/her measurements on the standardisation test form.
\end{enumerate}

Standardisation Test Form

Enumerator ID: \textbar{}\textbf{\textbar{}}\textbar{} Enumerator Name:
\textbar{}\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\textbar{} Measurement
Round: \textbar{}\_\_\textbar{}
...
 Each team starts with a different child, and each enumerator measures
the child once and records the results in a standard form for the 1st
measurement.  When each member of the team has done the measurements,
they should move on to the next child. After the 10 children have been
measured once by all enumerators the forms are handed in. The teams and
the children then take a break.  The whole process is repeated after
the break, but enumerators should not be able to see the previous
measurements.  Offer incentives to the mothers and children !
