...
\caption{2-piece height board standing up}\label{fig:unnamed-chunk-13}
\end{figure}
...
\caption{2-piece height board lying down}\label{fig:unnamed-chunk-14}
\end{figure}
...
\caption{2-piece height board folded and carried}\label{fig:unnamed-chunk-15}
\end{figure}
...
\caption{Length board flat on a stable surface}\label{fig:unnamed-chunk-16}
\end{figure}
...
\caption{Height board mounted upright}\label{fig:unnamed-chunk-17}
\end{figure}
...
\caption{Steps in measuring height}\label{fig:unnamed-chunk-18}
\end{figure}
...
\textbf{Note:} If you are unsure or not confident in the precision of
the child's age (over age 2), please take measurement as described
above. If the child's height is measured to less than 85 cm, you must
instead measure the child's length (see
\protect\hyperlink{measuring-length}{Measuring length}).
...
\caption{Steps in measuring length}\label{fig:unnamed-chunk-19}
\end{figure}
...
\caption{Positioning child's head against the base of the board}\label{fig:unnamed-chunk-20}
\end{figure}
...
\caption{Measurer and assistant working together to position child}\label{fig:unnamed-chunk-21}
\end{figure}
...
\textbf{Note:} If are unsure or not confident in the precision of the
child's age (under age 2), take measurement as described above. If the
child's length is measured to 85 cm or more, you must instead measure
the child's height (see \protect\hyperlink{measuring-height}{Measuring
height}).
...
\hypertarget{oedema}{%
\chapter{Measuring oedema}\label{oedema}}
