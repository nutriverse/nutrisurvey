...
```{r fig.cap = "2-piece height board standing up", echo = FALSE, fig.align = "center", fig.retina = 1}
knitr::include_graphics("images/heightBoard01.jpg")
```

```{r fig.cap = "2-piece height board lying down", echo = FALSE, fig.align = "center", fig.retina = 1}
...
```{r fig.cap = "Length board flat on a stable surface", echo = FALSE, fig.align = "center", fig.retina = 1}
...
```{r fig.cap = "Height board mounted upright", echo = FALSE, fig.align = "center", fig.retina = 1}
...
**Note:** If you are unsure or not confident in the precision of the child's age (over age 2), please take measurement as described above. If the child's height is measured to less than 85 cm, you must instead measure the child's length (see [Measuring length]).
...
```{r fig.cap = "Positioning child's head against the base of the board", echo = FALSE, fig.align = "center", fig.retina = 1}
...
```{r fig.cap = "Measurer and assistant working together to position child", echo = FALSE, fig.align = "center", fig.retina = 1}
...
**Note:** If are unsure or not confident in the precision of the child's age (under age 2), take measurement as described above. If the child's length is measured to 85 cm or more, you must instead measure the child's height (see [Measuring height]).
