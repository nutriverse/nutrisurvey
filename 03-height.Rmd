...
7. **Measurer** makes sure the child is lying flat and in the centre of the board (**arrow 7**) and places left hand on the child's shins (above the ankles) or on the knees (**arrow 8**) pressing them firmly against the board. With the right hand, **measurer** places the footpiece firmly against the child's heels (**arrow 9**).
