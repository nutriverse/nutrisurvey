...
|     |                       |                                                                      |  No = 2       |  
+-----+-----------------------+----------------------------------------------------------------------+---------------+
| B   | White roots and tubers| White potatoes, white yams, manioc/cassava/yucca, cocoyam, taro or   | Yes = 1       |  
|     |                       | any other foods made from white- eshed roots or tubers, or plantains |  No = 2       |
+-----+-----------------------+----------------------------------------------------------------------+---------------+
| C   | Pulses (beans, peas   | Mature beans or peas (fresh or dried seed), len ls or bean/pea       | Yes = 1       |  
...
+-----+-----------------------+----------------------------------------------------------------------+---------------+
| T   | Sugar-sweetened       | Sweetened fruit juices and “juice drinks”, softdrinks/fizzy drinks,  | Yes = 1       |
...
|     | **Food categories**   | **Description and/or examples (to be adapted to local context)**     | **Consumed?** |
+:===:+=======================+======================================================================+===============+
| U   | Condiments and        | Ingredients used in small quan  es for  avour, such as chilies,      | Yes = 1       | 
|     | seasonings            | spices, herbs,  sh powder, tomato paste,  avour cubes or seeds       |  No = 2       |
+-----+-----------------------+----------------------------------------------------------------------+---------------+
...
Consumption of any amount of food from each food group is suf cient to “count”, i.e., there is no minimum quantity, except if an item is only used as a condiment.
...
+-----+-------------------------------------------------------------------------+------------------+
| L   | Cheese, yogurt, or other milk products                                  | Yes = 1   No = 2 |
+-----+-------------------------------------------------------------------------+------------------+
...
+-----+-------------------------------------------------------------------------+------------------+
| O   | Condiments for flavor, such as chilies, spices, herbs, or fish powder   | Yes = 1   No = 2 |
+-----+-------------------------------------------------------------------------+------------------+
